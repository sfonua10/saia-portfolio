...
const solutions = [
  {
    ...
    description: "My own thoughts about the Gospel of Jesus Christ",
    href: "#",
    icon: SunIcon,
  },
  {
    name: "Tech",
    description: "My learning and progression within Tech",
    href: "#",
        ...
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <a href="#">
              ...
              <img className="h-8 w-auto sm:h-10" src="/sf-logo.svg" alt="" />
            </a>
          </div>
              ...
              <Popover className="relative">
                {({ open }) => (
                  <>
                    ...
                    >
                      <Popover.Panel className="absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 md:-translate-x-3/4">
